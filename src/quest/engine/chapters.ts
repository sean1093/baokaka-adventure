 ...
 * Decor is placed in the SQUARE battle box, so y is also a fraction of the width;
 * foes stand around y 0.32 and heroes around y 0.8, so decor keeps to the top and the edges.
 */
